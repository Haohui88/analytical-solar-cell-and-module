...
Options[SiCell]={LuminescentCoupling->0,DeviceArea->1,DeviceParameters->parameters["PERC"],DeviceQE->EQE["PERC"],MetalCoverage->0};
...
parameters["PERC"]=<|"J01"->2*10^-9,"J02"->1*10^-8,"Rs"->0.9*10^-4,"Rsh"->10000*10^-4|>; (* STC parameters in SI unit: J01, J02, Rs, Rsh *)
...
SiCell[spec_,T_,opt:OptionsPattern[]]:=Module[{Eg,cellArea,cellParameterList,QE,J01,J02,Rs,Rsh,jscTc,Tstc,IV,voltage,current,step,vmax,Jmpp,Vmpp,V,J,P,Jsc,Voc,t,FF,Pmpp,n1,n2},
Tstc=273.15+25;
